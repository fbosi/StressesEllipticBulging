...
# This repository contains the files to directly determine the stresses during elliptic bulge tests, once the thin shell shape, loading and boundary conditions are known.

The folder contains two main files, developed in Matlab, that work independently:
